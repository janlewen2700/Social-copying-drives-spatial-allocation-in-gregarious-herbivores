...
def set_article_style():
    ...
    mpl.rcParams.update({
        ...
        "axes.labelsize": 8,      # Slightly larger for readability
        "axes.titlesize": 10,
        "legend.fontsize": 8,
        "xtick.labelsize": 8,
        "ytick.labelsize": 8,
        ...
        "figure.subplot.left": 0.13,   # Room for the Y-axis label
        "figure.subplot.bottom": 0.07, # Room for the X-axis label
        "figure.subplot.right": 0.85,  # Small margin on the right
        "figure.subplot.top": 0.96,     # Small margin on the top
